...
export const TimelineLeft = ({ data }: { data: TimelineEntry[] }) => {
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex z-40 items-start top-40 self-start w-full">
              {/* <div className="h-10 absolute left-3 lg:left-3 w-10 rounded-full bg-secondary  dark:bg-black flex items-center justify-center">
              ...
              <div className="pr-12 w-full self-start">{item.content} </div>
            </div>
          </div>
        ))}
        {/* <div
