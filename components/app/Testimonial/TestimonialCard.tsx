...
const TestimonialCard = ({ data }: { data: any }) => {
  return (
    <div className="p-8 pr-4 md:p-8 pb-10 w-[92vw] md:w-[32vw] bg-dark_secondary border-[1px] border-gray-700 rounded-md mr-[2vw]">
        <div className="flex items-center gap-4">
            ...
            />
            <div>
                <p className="text-lg md:text-xl font-bold">Aaron Reid</p>
                <p className="text-gray-400 font-semibold md:mt-1">Founder & CEO, Traction</p>
            </div>
        </div>
